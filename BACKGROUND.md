...
### 2.1.3 상호참조관계와 언어적 제약조건들
* 수(數)일치
* 인칭(人稱)일치
* 성(性)일치
* 결속이론(Binding Theory)의 제약들
* 문장성분(Grammatical Roles) 관련 제약들
* 동사 관련 제약
* 선택적 제약들
...
### 2.2.4 상호참조해결 알고리즘 구현을 위한 아키텍처들
* 멘션쌍 아키텍처
* 멘션 순위 아키텍처
* 엔티티 기반 모델

### 2.2.5 자질(features)을 활용한 분류기(classifiers)의 역할
### 2.2.6 신경망 기반 멘션 순위 판별 알고리즘
* 
